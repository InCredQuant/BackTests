...
sys.path.insert(1, r'G:\Shared drives\BackTests\pycode\commons\\')
from commons.order_base import Order, Position, OptionType, Segment
from commons.trade_register import TradeRegister
from commons.stats import Stats, Filter
...
2: ['HDFCB IN', 'AXSB IN', 'INFO IN', 'MSIL IN', 'KMB IN', 'ADSEZ IN', 'BHARTI IN', 'HCLT IN', 'MM IN', 'TECHM IN', 'DLFU IN', 'RBK IN', 'LTI IN', 'IGL IN', 'TATACONS IN', 'INFOE IN', 'MRF IN', 'POLYCAB IN', 'MRCO IN', 'ESCORTS IN'], 
...
12: ['TATA IN', 'TTAN IN', 'IIB IN', 'HNDL IN', 'JSTL IN', 'JSP IN', 'MMFS IN', 'SRF IN', 'BHFC IN', 'DIVI IN', 'ICEM IN', 'AL IN', 'LICHF IN', 'CIFC IN', 'SAIL IN', 'BHE IN', 'MUTH IN', 'SHTF IN', 'DN IN', 'NMDC IN', 'SBILIFE IN', 'LTTS IN', 'IHFL IN', 'NFIL IN', 'SUNTV IN', 'GRAN IN', 'NACL IN', 'AMRJ IN', 'HDFCAMC IN', 'HPCL IN', 'MAHGL IN', 'CRIN IN', 'INMART IN', 'HCP IN', 'BOOT IN', 'GUJS IN']}

liqList = ['RIL IN', 'HDFCB IN', 'ICICIBC IN', 'AXSB IN', 'SBIN IN', 'ADE IN', 'INFO IN', 'MSIL IN', 'BAF IN', 'TTMT IN', 'TCS IN', 'KMB IN', 'ADSEZ IN', 'BHARTI IN', 'CBK IN', 'BOB IN', 'TATA IN', 'TTAN IN', 'WPRO IN', 'LT IN', 'HCLT IN', 'TPWR IN', 'IIB IN', 'VEDL IN', 'HUVR IN', 'UPLL IN', 'MM IN', 'HNDL IN', 'JSTL IN', 'BJFIN IN', 'TECHM IN', 'DLFU IN', 'COAL IN', 'HNAL IN', 'IDFCFB IN', 'IH IN', 'MTCL IN', 'NTPC IN', 'FB IN', 'JSP IN', 'MMFS IN', 'SRF IN', 'IRCTC IN', 'TTCH IN', 'DRRD IN', 'BHFC IN', 'DIVI IN', 'RBK IN', 'ICEM IN', 'SRCM IN', 'AL IN', 'BANDHAN IN', 'GRASIM IN', 'TVSL IN', 'LICHF IN', 'PVRL IN', 'LTI IN', 'CIFC IN', 'APHS IN', 'SAIL IN', 'JUBI IN', 'BRIT IN', 'AUBANK IN', 'APTY IN', 'CCRI IN', 'IDFC IN', 'GNFC IN', 'PIDI IN', 'HAVL IN', 'INDIGO IN', 'BHE IN', 'ONGC IN', 'IGL IN', 'TATACONS IN', 'MUTH IN', 'VOLT IN', 'SHTF IN', 'DN IN', 'TRENT IN', 'NMDC IN', 'NEST IN', 'SBILIFE IN', 'LTTS IN', 'INFOE IN', 'IHFL IN', 'SBICARD IN', 'NFIL IN', 'ZYDUSLIF IN', 'ABFRL IN', 'ABB IN', 'SUNTV IN', 'ARBP IN', 'IEX IN', 'KKC IN', 'MRF IN', 'POLYCAB IN', 'CANF IN', 'GRAN IN', 'LTFH IN', 'PSYS IN', 'COFORGE IN', 'IOCL IN', 'CUBK IN', 'NACL IN', 'GCPL IN', 'MOTHERSO IN', 'AMRJ IN', 'POWF IN', 'MRCO IN', 'ESCORTS IN', 'GPL IN', 'BRGR IN', 'BIL IN', 'GUJGA IN', 'HDFCAMC IN', 'SIEM IN', 'OBER IN', 'MPHL IN', 'TCOM IN', 'PIEL IN', 'PI IN', 'GMRI IN', 'ARTO IN', 'BOS IN', 'HPCL IN', 'DIXON IN', 'RECL IN', 'ASTRA IN', 'ICICIGI IN', 'BRCM IN', 'BATA IN']
...
class DailyTradingSignals(FactoryBackTester):
    ...
    def basicdatainitialize(self):
        self.CurrentTime = pandas.to_datetime('2022-08-31')# '2013-01-07'
...
if __name__=='__main__':
    ...
    dataFile = dirPath +'Pickles/Live_FutsData14Nov-2022.pkl'
    f = open(dataFile, 'rb')
    mydata = pickle.load(f)
    f.close()
    basePath = dirPath+'BacktestsResults/DailyTradingSignals_V2/'
