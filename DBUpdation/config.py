...
config = {
    ...
    'db_uri': "postgresql+psycopg2://postgres:postgres@10.147.0.69:5432/autodash",
    'histdb_uri': "postgresql+psycopg2://postgres:postgres@10.147.0.69:5432/data",
    'pfdb_uri': "postgresql+psycopg2://postgres:postgres@10.147.0.69:5432/portfolio",
    ...
    'get_bse_fno_columns' : ['Ticker', 'Instrument', 'Scrip', 'Expiry', 'Strike', 'OptionType', 'Open', 'High', 'Low', 'Close', 'SettlePrice', 'Contracts', 'Val_Lakh', 'OI', 'ChgOI', 'Date'],
