...
class DailyTradingSignals(FactoryBackTester):
    ...
    def basicdatainitialize(self):
        #self.CurrentTime = pandas.to_datetime('2024-01-31')##('2010-01-01')#('2022-08-31')# '2013-01-07'#'2022-12-31'
        self.CurrentTime = pandas.to_datetime('2011-06-27')#('2023-09-25')
    ...
    def UpdateSpecificStats(self):        
        ...
        tickers = set(self.Close.loc[self.CurrentTime].dropna().index)
...
if __name__=='__main__':
    ...
    dataFile = 'G:/Shared drives/QuantFunds/Liquid1/DataPickles/STFDMOM_20250902.pkl'#All20250625.pkl
    f = open(dataFile, 'rb')
    mydata = pickle.load(f)
    f.close()
    
    basePath = dirPath+'BacktestsResults/DailyTradingSignals_Sep2025/'
