...
class DispersionNifty(FactoryBackTester):
    ...
    def updateCapAllocation(self):
        ...
        self.UpdateOrderBook(strategyID = 'NiftyDispersion', options = 'y')
...
if __name__=='__main__':
    ...
    if os.path.exists('Z:/Pickles/'):
        pickleFile = 'Z:/Pickles/NiftyDispersionData22Mar-2023.pkl'
    else:
        pickleFile = 'G:/Shared drives/BackTests/Pickles/NiftyDispersionData22Mar-2023.pkl'
    ...
    basePath = 'G:/Shared drives/BackTests/BackTestsResults/Dispersion/Nifty/'
    if not os.path.exists(basePath):
        path = Path(basePath)
        path.mkdir(parents=True)
        #os.mkdirs(basePath)       
    backtestName = 'NiftyDispersion_'
