...
class RollingStrangle(FactoryBackTester):
...
if __name__=='__main__':
    ...
    INDEXNAME = 'NIFTY'
    slippage = '1pct'
    strategy = f'RollingStrangle_5MaxRolls_DoublePtsAsAwayStrikes_{slippage}_Slippage'
    
    
    #rollAt = 0.05/10# 50bps Change Roll
    rollList = [0.0100]#, 0.0050, 0.0100, 0.0150, 0.020]#[0.0020, 0.0030, 0.0040, 0.0050, 0.0060, 0.0080]
