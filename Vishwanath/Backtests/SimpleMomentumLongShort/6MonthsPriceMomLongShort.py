...
class SimpleMomenutmLongShort(FactoryBackTester):
    ...
    def GetMomRanks(self, ClosePrice, stocksList):       
        ...
        self.MomentumRanks = SixMonthsMom
        #self.VolRanks = ThreeMonthsStd
    ...
    def updateCapAllocation(self):
        ...
        self.UpdateOrderBook(strategyID = 'STFMMOM6M')
        print(self.CurrentTime.date(), len(longStocks), len(shortStocks), len(self.FactorRanks))
